    ...
    <header id="header" role="banner" class="clearfix">
        <div class="container">
            ...
            <div id="header-inside" class="clearfix">
                <div class="row">
                    <div class="col-md-4" id="headerBlock1">
                        <?php if ($site_name): ?>
                            <div id="site-name">
                    ...
                    <div class="col-md-4" id="headerBlock3">
...
<!-- Added for c-bear -->
<script src="/sites/all/themes/mybootstrap_business/js/jquery.min.js"></script>
<script src="/sites/all/themes/mybootstrap_business/js/backstretch.js"></script>
<script src="/sites/all/themes/mybootstrap_business/js/bootstrap.js"></script>

<script> $("#header").backstretch(["/sites/all/themes/mybootstrap_business/images/openbearbg.png"]); </script>

<script> $
    ("#subfooter").backstretch(["/sites/all/themes/mybootstrap_business/images/bottombw.jpg"]); </script>
